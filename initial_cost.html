    ...
    <main>
        <div class="container">
            ...
            <dl>
                ...
                <section id="section2">
                    <dt>家電<span class="value">= {{ totalCost }}</span></dt>
                    <dd>
                        <ul>
                ...
                <section id="section3">
                    <dt>家具<span class="value">= {{ totalCost }}</span></dt>
                    <dd>
                        <ul>
                ...
                <section id="section4">
                    <dt>生活用品<span class="value">= {{ totalCost }}</span></dt>
                    <dd>
                        <ul>
                ...
                <section id="section5">
                    <dt>引っ越し費用<span class="value">= {{ totalCost }}</span></dt>
                    <dd>
                        <ul>
